@php
    ...
    $nivelActual = old(
        ...
        $estudiante?->nivel_escolaridad_id
    );

    $fechaIngresoActual = old(
        'fecha_ingreso',
        $estudiante?->fecha_ingreso?->format('Y-m-d')
            ?? now()->format('Y-m-d')
    );
        ...
        <section class="portal-card portal-form-card">
            ...
            <div class="portal-form-section-header">
                ...
                <div>
                    ...
                    <p>
                        Datos personales que formarán parte del expediente.
                    </p>
                </div>
            ...
            <div class="portal-form-section-body">
                ...
                @if ($modoEdicion)
                    ...
                    <div class="portal-form-help mt-3">
                        La persona asociada y el código EDMA no pueden cambiarse
                ...
                @else
                    ...
                    <div class="mb-3">
                        ...
                        >
                            ...
                            @foreach ($personasDisponibles as $persona)
                                ...
                                <option
                                    ...
                                    data-document-type="{{ $persona->tipo_documento }}"
                        ...
                        <div class="portal-form-help">
                            Solo aparecen personas activas que todavía no poseen
                    ...
                    @if ($personasDisponibles->isEmpty())
                        ...
                        <div class="portal-inline-notice portal-inline-notice-warning">
                            ...
                            <div>
                                ...
                                <span>
                                    Registre primero una persona o revise si ya
                                    posee expediente de estudiante.
                                </span>
                            </div>
                    ...
                    >
                        ...
                        <div class="portal-student-person-avatar">
                            ...
                            <span
                                ...
                                @if ($personaSeleccionada?->foto_perfil) hidden @endif
                            >
                                {{ $personaSeleccionada?->iniciales ?: 'ES' }}
                            </span>
        ...
        <section class="portal-card portal-form-card">
            ...
            <div class="portal-form-section-header">
                ...
                <div>
                    ...
                    <p>
                        Datos administrativos propios del expediente.
                    </p>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <select
                            ...
                            class="form-select portal-form-control
                                @error('nivel_escolaridad_id') is-invalid @enderror"
                        >
                            <option value="">
                                No especificado
                            </option>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <input
                            ...
                            class="form-control portal-form-control
                                @error('profesion_ocupacion') is-invalid @enderror"
                            maxlength="150"
                        >
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="portal-form-help">
                            El año de esta fecha será utilizado para generar el
                            código institucional EDMA.
                        </div>
            ...
            <section class="portal-card portal-form-card">
                ...
                <div class="portal-form-section-header">
                    ...
                    <div>
                        ...
                        <p>
                            Identificador visible del estudiante.
                        </p>
                    </div>
                ...
                <div class="portal-form-section-body">
                    ...
                    <ul class="portal-form-guidelines">
                        ...
                        <li>
                            ...
                            <span>
                                La información personal proviene del módulo
                                Personas.
                            </span>
                        </li>
                        ...
                        <li>
                            ...
                            <span>
                                Una persona solo puede tener un expediente
                                estudiantil.
                            </span>
                        </li>
                        ...
                        <li>
                            ...
                            <span>
                                El código EDMA nunca podrá modificarse.
                            </span>
                        </li>
                        ...
                        <li>
                            ...
                            <span>
                                El historial se conservará aunque el estudiante
                                sea desactivado.
                            </span>
                        </li>
                ...
                <div class="portal-form-actions">
                    ...
                    <a
                        href="{{ $modoEdicion
                            ...
                            : route('portal.estudiantes.index') }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const updatePersonPreview = () => {
                ...
                if (personDocument && personDocumentWrapper) {
                ...
                if (personEmail && personEmailWrapper) {
                ...
                if (personPhone && personPhoneWrapper) {
